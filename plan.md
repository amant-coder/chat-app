...
> [!IMPORTANT]
> **Reset flow**: I'm proposing a **5-digit OTP code** sent to the user's email (not a URL link). The user enters their email → receives a code → enters code + new password. This is simpler, more mobile-friendly, and avoids needing a publicly accessible server URL. Good?
...
You are helping a user configure Clerk DNS for the production domain `aman-devop.me`.
...
- Useful commands include: `dig +short NS aman-devop.me`, `whois aman-devop.me`, and `nslookup -type=NS aman-devop.me`.
