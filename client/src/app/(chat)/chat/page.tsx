...
export default function ChatPage() {
  ...
  return (
    <div className="flex h-screen w-full bg-(--bg-primary) overflow-hidden relative">
      ...
      <div
        className={`
          absolute md:static inset-0 w-full md:w-[320px] lg:w-[360px] xl:w-[400px] h-full flex-shrink-0 bg-(--bg-secondary) border-r border-(--border) z-20
      ...
      <div
        className={`
          absolute md:static inset-0 w-full md:w-auto md:flex-1 h-full bg-(--bg-primary) z-10
          transition-transform duration-300 ease-out flex flex-col min-w-0
